package com.praveen.gupta.retrofithome.Model;
...
public class JsonData implements Parcelable {
    ...
    public final static Parcelable.Creator<JsonData> CREATOR = new Creator<JsonData>() {
        ...
        public JsonData createFromParcel(Parcel in) {
            ...
            in.readList(instance.popular, (com.praveen.gupta.retrofithome.Model.Popular.class.getClassLoader()));
            in.readList(instance.data, (com.praveen.gupta.retrofithome.Model.Datum.class.getClassLoader()));
